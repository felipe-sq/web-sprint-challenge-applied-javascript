...
.then(({data}) => {
    ...
    // const singleArticleJS = articlesJS[0]
    // console.log(singleArticleJS)
...
// Re-wrote code to be able to use .forEach() method to iterate through each topic
// and deleted verbose code to help clean up the file.
